...
namespace Krucial_API.Migrations
{
    ...
    [Migration("20240818053919_Added_Order_Header_Details")]
    partial class Added_Order_Header_Details
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Krucial_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Krucial_API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Krucial_API.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("Krucial_API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Krucial_API.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Krucial_API.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Krucial_API.Models.CartItem", b =>
                {
                    b.HasOne("Krucial_API.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Krucial_API.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Krucial_API.Models.OrderDetails", b =>
                {
                    b.HasOne("Krucial_API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("Krucial_API.Models.OrderHeader", b =>
                {
                    b.HasOne("Krucial_API.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Krucial_API.Models.ApplicationUser", null)
                        .WithMany()
